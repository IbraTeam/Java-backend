                ...
                .authorizeHttpRequests(requests ->
                        requests
                               ...
                               // .requestMatchers(HttpMethod.GET, "/api/account/users").authenticated()
                                ...
                                .requestMatchers(HttpMethod.POST, " /api/audience-key").hasRole("DEAN", "ADMIN")
                                .requestMatchers(HttpMethod.DELETE, " /api/audience-key").hasRole("DEAN", "ADMIN")
                                .requestMatchers(HttpMethod.PATCH, "/api/audience-key/give/*").hasAnyRole("STUDENT", "TEACHER", "DEAN", "ADMIN")
                                .requestMatchers(HttpMethod.POST, "/api/audience-key/get").hasAnyRole("STUDENT", "TEACHER", "DEAN", "ADMIN")
                                .requestMatchers(HttpMethod.POST, "/api/audience-key/return/*").hasAnyRole("STUDENT", "TEACHER", "DEAN", "ADMIN")
